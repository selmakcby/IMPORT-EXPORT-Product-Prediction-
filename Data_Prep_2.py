...
def process_chunk(chunk, partner_mapping, product_mapping, reporter_mapping):
    ...
    # Merge with reporter details
    chunk = chunk.merge(reporter_mapping, left_on='Reporter', right_index=True, how='left')
    return chunk
...
def main():
    ...
    reporter_mapping = load_mapping('/Users/selma/Downloads/tradeconnectivity/selected_economy.csv', 'Reporter')
    ...
    for i, chunk in enumerate(reader):
        processed_chunk = process_chunk(chunk, partner_mapping, product_mapping, reporter_mapping)
